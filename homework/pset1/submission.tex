...
It turns out that you can improve these bounds all the way down to $\RMQcomplexity{\bigo{mn}}{\bigo{1}}$ using some very clever techniques. This might make for a fun final project topic if youâ€™ve liked our discussion of RMQ so far!
